...
// based on https://github.com/aframevr/aframe/blob/v1.4.0/src/components/look-controls.js
...
AFRAME.registerComponent('orbit-camera', {
  ...
  schema: {
    ...
    magicWindowTrackingEnabled: {default: false},
    pointerLockEnabled: {default: false},
    reverseMouseDrag: {default: false},
    reverseTouchDrag: {default: false},
    touchEnabled: {default: true},
    mouseEnabled: {default: true},
    startingPitch: {default: 0},
    startingYRotation: {default: 0}
  },
  ...
  */
  setupMouseControls: function () {
    ...
    let startingPitchRadians = THREE.MathUtils.degToRad(this.data.startingPitch);
    this.pitchObject = new THREE.Object3D(); 
    this.pitchObject.setRotationFromEuler(new THREE.Euler(startingPitchRadians, 0, 0, 'XYZ'));

    let startingYRotationRadians = THREE.MathUtils.degToRad(this.data.startingYRotation);
    this.yawObject = new THREE.Object3D();
    this.yawObject.rotation.y = this.data.startingYRotation;
//    this.yawObject.setRotationFromEuler(new THREE.Euler(0, startingYRotationRadians, 0, 'XYZ'));
